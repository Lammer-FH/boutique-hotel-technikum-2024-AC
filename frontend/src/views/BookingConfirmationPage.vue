<template>
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <div class="container">
        <div v-if="store.loading">Loading the Booking...</div>
        <div v-else>
          ...
          <ion-card>
            ...
            <ion-card-content>
              <p>
                <strong>First Name:</strong> {{ store.booking.guest.firstName }}
              </p>
              <p>
                <strong>Last Name:</strong> {{ store.booking.guest.lastName }}
              </p>
              <p><strong>Email:</strong> {{ store.booking.guest.email }}</p>
              <p>
                <strong>Breakfast:</strong>
                {{ store.booking.breakfast ? "Yes" : "No" }}
              </p>
          ...
          <ion-card>
            ...
            <ion-card-content>
              <p>
                ...
                <a href="mailto:support@technikum-botique.at"
                  >support@technikum-botique.at</a
                >
              </p>
...
export default {
  ...
  setup: () => {
    ...
    const bookingId = Array.isArray(route.params.id)
