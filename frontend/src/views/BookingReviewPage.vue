    ...
    <ion-content class="ion-padding">
      <ion-card>
        ...
        <ion-card-content>
          ...
          <p>
            <strong>Breakfast:</strong> {{ booking.breakfast ? "Yes" : "No" }}
          </p>
...
watch(selectedRoomId, (newRoomId) => {
  if (newRoomId !== undefined) {
    booking.room =
      availableRooms.value.find((room) => room.id === newRoomId) || null;
  }
});

watch(
  () => roomSelectionStore.endDate,
  (newEndDate) => {
